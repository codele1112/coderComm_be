...
useController.register = catchAsync(async (req, res, next) => {
...
useController.getUsers = catchAsync(async (req, res, next) => {
  // Get data from request
...
useController.getCurrentUser = catchAsync(async (req, res, next) => {
  // Get data from request
  const currentUserId = req.userId;
  // Validation
...
useController.getSingleUser = catchAsync(async (req, res, next) => {
  // Get data from request
  const currentUserId = req.userId;
  ...
  //  show friendship current user vs target user
  user = user.toJSON();
...
useController.updateProfile = catchAsync(async (req, res, next) => {
  // Get data from request
  const currentUserId = req.userId;
  const targetUserId = req.params.id;
  // Validation
